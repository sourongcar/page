...
$(document).ready(function(){
    ...
    $.ajax({
        type:"get",
        url: getUrl()+"/brand/weblist.action",
        async:true,
        success:function(data){
            ...
            $.each(data, function(i,n) {
                ...
                images+="<a href='searchcarlist.html?brandid="+n["brandid"]+"&&brandpic="+n["brandpic"]+"'><img  src='"+getImgUrl()+n["brandpic"]+"'"+"class='car-sign-img'></a>";
