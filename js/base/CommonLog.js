    ...
    $("[LOGWT]").each(function () {
        ...
        if (v) {
            $(this).click(function (e) {
                ...
                var d = new Date();
                if (vipwts != "") {
                    CreateScript("http://log.taoche.cn/Log.ashx?mReferrer=" + encodeURIComponent(mReferrer) + "&logwt=" + encodeURIComponent(vipwts) + "&TCID=" + TCID + "&note=&v=" + d.getMilliseconds());
                }
            });
        }
...
function clickact(txt) {
    ...
    if (txt) {
        txt = txt.toLowerCase();   
            ...
            var d = new Date();
            if (txt != "") {
                CreateScript("http://log.taoche.cn/Log.ashx?mReferrer=" + encodeURIComponent(mReferrer) + "&logwt=" + encodeURIComponent(txt) + "&TCID=" + TCID + "&note=&v=" + d.getMilliseconds());
            } 
    }
}
function behaveact(txt) {
    if (txt) {
        ...
        var d = new Date();
        if (txt != "") {
            CreateScript("http://log.taoche.cn/UserBehavior.ashx?mReferrer=" + encodeURIComponent(mReferrer)
